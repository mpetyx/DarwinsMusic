...
class dbpedia:
    ...
    def getInfluences(self, artisturi):
        """
        Gets the list of artists who influenced the given artist
        """
        ...
        SELECT ?influences WHERE {
         { %s dbpedia-owl:influencedBy ?influencedBy } UNION { ?influencedBy dbpprop:influences %s }
         }
        """%artisturi)
    ...
    def getInfluenced(self, artisturi):
        """
        Gets the list of artists who are influenced by the given artist
        """
        self.sparql.setQuery("""
        PREFIX owl: <http://www.w3.org/2002/07/owl#>
        PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
        ...
        SELECT ?influences WHERE {
         { ?influenced dbpedia-owl:influencedBy %s } UNION { %s dbpprop:influences ?influenced }
         }
        """%artisturi)
